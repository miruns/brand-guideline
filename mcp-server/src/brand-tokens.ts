...
export const brand = {
  ...
  description:
    "Miruns integrates seamlessly into everyday headphones — capturing EEG, heart rate, HRV, and environmental data without interrupting your training or your day. The companion app processes these signals with AI to deliver real-time fatigue prediction, recovery tracking, and personalised health insights.",

  // ── Colors ──────────────────────────────────────────────────
  colors: {
    philosophy:
      "Miruns uses a dual-theme system. The dark theme is primary — it reflects the product's focus on deep focus and neural signals. The light theme serves documentation and daylight contexts.",
    dark: {
    ...
    accentUsage: {
      light: {
        hex: "#0070F3",
        usage:
          "Light-mode accent. Used for links, buttons, and interactive elements on light backgrounds.",
      },
      dark: {
        hex: "#00E5FF",
        usage:
          "Dark-mode accent (cyan). Used for highlights and data visualizations on dark backgrounds. Evokes neural activity.",
      },
    },
  },
  ...
  logo: {
    ...
    clearSpace:
      "Maintain a minimum clear space equal to the height of the 'm' in the wordmark on all sides.",
    minimumSize: {
  ...
  iconography: {
    ...
    colorRule:
      "Icons inherit currentColor. Use foreground for primary, muted for secondary, accent for interactive states.",
    availableIcons: [
      "Brain",
      "Activity",
      "Heart",
    ...
    principles: [
      {
        name: "Precise",
        description:
          'We use clear, specific language. No buzzwords. If we mention EEG, we explain what it does — not just that it\'s "advanced."',
      },
      {
        name: "Calm",
        description:
          "Our tone is confident but never aggressive. We inform rather than hype. Data speaks; we amplify it with clarity.",
      },
      {
        name: "Human",
        description:
          "We talk to athletes, students, workers — real people. Language is accessible, warm, and avoids clinical distance.",
      },
      {
        name: "Forward",
        description:
          "We look ahead. Our language reflects innovation and progress without being utopian or making unrealistic promises.",
      },
    ],
    doExamples: [
